...
Définition à la ligne 226 du fichier billet\+Manager.\+php.
...
Définition à la ligne 242 du fichier billet\+Manager.\+php.
...
\begin{DoxyParams}{Paramètres}
{\em \$offset} & = détermine la position de départ dans la base de donnée \\
\hline
{\em \$limit} & = détermine le nombre de billet à afficher \\
\hline
\end{DoxyParams}
...
Définition à la ligne 153 du fichier billet\+Manager.\+php.
