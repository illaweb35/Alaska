    ...
    <div class="box">
      <form action="<?= BASEPATH . 'Backedit/Create' ?>" method="post" enctype="multipart/form-data">
        <div class="field">
          ...
          <input type="text" name="title" class="input" placeholder="Ici votre titre " value="<?php if (isset($_POST['title'])) {
                                                                                                echo Verif::filterName($_POST['title']);
                                                                                              } ?>" autofocus />
        </div>
        <div class="field">
          <div class="control">
            <textarea class="textarea" id="TinyModif" rows="8" type="text" name="content" value="<?php if (isset($_POST[content])) {
                                                                                                    echo $_POST['content'];
                                                                                                  } ?>">
            </textarea>
          </div>
